...
export const getAdvisoryArchetype = (query: string): ProjectBrief => {
  ...
  if (
    ...
    return {
      ...
      overview: `A specialized property management architecture designed for "${titleClean}". It automates room allocations, tenant boarding, lease agreements, monthly rent invoicing, maintenance ticket queues, and facility logs.`,
      pros: [
